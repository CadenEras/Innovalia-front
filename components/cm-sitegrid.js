			...
			{sites.map((site) => (
				<div className='cm-site' key={site.id}>
					...
					<div className='cm-site-details'>
						...
						<p className='cm-site-text'>
							Nombre de salles max : {site.Sit_Nombre_Salles_Max}
						</p>
						<p className='cm-site-text'>
							Horaire : {site.Sit_Heure_Ouverture} à {site.Sit_Heure_Fermeture}
						</p>
