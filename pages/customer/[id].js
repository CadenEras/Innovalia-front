					...
					<div className="p-3 py-5">
						...
						<div className="row mt-2">
							<div className="col-md-6">
								...
								<input type="text" className="form-control" placeholder="Prénom" value={user.Per_Prenom}/>
							</div>
							<div className="col-md-6">
								<label className="labels">Nom</label>
								<input type="text" className="form-control" value={user.Per_Nom} placeholder= "user.Per_Nom"/>
							</div>
						</div>
						<div className="row mt-3">
							<div className="col-md-12">
								<label className="labels py-1">Email</label>
								<input type="email" className="form-control" placeholder="email" value={user.Per_Email}/>
							</div>
							{/* et ainsi de suite pour les autres informations utilisateur... */}
						</div>
						<div className="mt-5 text-center">
							<button className="cm-orange-button cm-btn w-100 w-md-50 mx-auto mt-4" type="button">Modifier le profil</button>
						</div>
					</div>
				</div>
			</div>
