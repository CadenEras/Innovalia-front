...
const ateliers = [
	{
		...
		image: "/Asset 1.png",
		description:
			"Découvrez les délices de la cuisine méditerranéenne lors de cet atelier inoubliable.",
		location: "Paris",
		price: "$50",
		date: "2023-05-20",
	},
...
const EventPage = () => {
	return (
		<>
			{/* En-tête de la page */}
			<header className='cm-header'>{/* Contenu de l'en-tête */}</header>

			{/* Section des événements */}
			<section className='cm-theme-bg'>
				<h2 className='cm-title-section'>Voici nos prochains événements :</h2>
			...
			<section className='cm-theme-bg'>
				<div className='container'>
					<h2 className='cm-title-section' id='atelier-titre'>
						Ateliers sur site
					</h2>
					<h3 className='description-section'>
						Découvrez nos ateliers pour apprendre à cuisiner de délicieux plats.
					</h3>
